...
const markersAdresses = {
    ...
    ramsgarden: `${baseFolder}ramsgarden.svg`,
  };
...
export async function fetchMarkersData(google) {
    ...
    const buildLogoSize = new google.maps.Size(82,100);
...
function mockData() {
    return [
        ...
        {
          "name": "Rams Garden Bayramoğlu",
            "code": "ramsgarden",
            "list": [
                {
                    "name": "<a style='text-decoration:none; color: rgba(0,151,217,1); font-weight: bold' target='_blank' href='https://ramsgarden.com/'>Rams Garden Bayramoğlu</a>",
                    "id": "00",
                    "coordinations": {
                        "latitude": "41.0074626",
        ...
        //     "list": [
        //         {
        //             "name": "<a style='text-decoration:none; color: rgba(0,151,217,1); font-weight: bold' href='https://rams-global.com/' target='_blank'>Rams Türkiye</a>",
        //             "id": "10",
        //             "coordinations": {
        //                 "latitude": "40.997902",
        //                 "elevation": "29.098045"
