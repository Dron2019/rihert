    ...
    resources: {
      ru: {
        ...
        translation: {
          ...
          send: 'Отправить',
          sending: 'Отправка',
          field_too_short: 'Введите корректный номер телефона',
          field_too_long: 'Введите корректный номер телефона',
      ...
      uk: {
        ...
        translation: {
          ...
          field_too_short: 'Введіть коректний номер телефону',
          field_too_long: 'Введіть коректний номер телефону',
